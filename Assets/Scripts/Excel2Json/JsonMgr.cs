...
{
    JsonUtlity,
    NewtonsoftJson, // 新增Newtonsoft.Json选项
}
...
public class JsonMgr
{
    ...
    public void SaveData(object data, string fileName, JsonType type = JsonType.NewtonsoftJson)
    {
        ...
        switch (type)
        {
            case JsonType.JsonUtlity:
                ...
                break;
            case JsonType.NewtonsoftJson: // 添加Newtonsoft.Json的序列化
    ...
    public T LoadData<T>(string fileName, JsonType type = JsonType.NewtonsoftJson,string streamingAssetsPath=null) where T : new()
    {
        //确定从哪个路径读取
        string path = null;
        ...
        {
            path = Application.streamingAssetsPath + "/" + streamingAssetsPath + "/" + fileName + ".json";
        }
        ...
        switch (type)
        {
            case JsonType.JsonUtlity:
                ...
                break;
            case JsonType.NewtonsoftJson: // 添加Newtonsoft.Json的反序列化
